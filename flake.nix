{
  description = "bevy_glacial — reusable 3D-scene niceties for Bevy editor apps, development shell";
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        # .envrc exports GLACIAL_NVIDIA_VERSION from /proc/driver/nvidia/version
        ...
        nvidiaVersion = let v = builtins.getEnv "GLACIAL_NVIDIA_VERSION";
        in if v != "" then v
           else throw "bevy_glacial: GLACIAL_NVIDIA_VERSION is unset — is direnv loaded and is the NVIDIA driver running?";
